...
/**
 * Set the global products_list variable to the full_products_list
 * Hide the master_data_div element and display the master_div_element as a flex container
 */
function reg_herf() {
